...
type XdrAsset string

func (a XdrAsset) MarshalBinary() ([]byte, error) { return base64.StdEncoding.DecodeString(string(a)) }
func (a XdrAsset) XdrJsonTypeName() string        { return "Asset" }
...
func TestDecodeInterface(t *testing.T) {
	...
	*/
	...
	jsb, err := DecodeInterface(XdrAsset("AAAAAUFCQ0QAAAAAY3NrWbIzxOdwa+BhWFLSODTyh99xwpyb1gTzTQjDvGE="))
	require.NoError(t, err)
